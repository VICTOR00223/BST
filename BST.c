...
void delete(tp *x, int data)
{
	...
	if((*x == root) && ((*x)->key == data))//Θελω να διαγραψω τη ρίζα
	{
		if(((*x)->right == NULL) && ((*x)->left == NULL))//Χωρις παιδια
		{
			printf("\n1D");
			free(*x);
			*x = NULL;
		...
		else if(((*x)->right == NULL) && ((*x)->left != NULL))//Μονο αριστερό παιδι
		{
			printf("\n2D");
			tp temp = *x;
			*x = (*x)->left;
		...
		else if(((*x)->right != NULL) && ((*x)->left == NULL))//Μονο δεξι παιδι
		{
			printf("\n3D");
			tp temp = *x;
			*x = (*x)->right;
		...
		else if(((*x)->right != NULL) && ((*x)->left != NULL))//εχει 2 παιδια
		{
			printf("\n4D");
			tp right = (*x)->right;
			tp left = (*x)->left;
	...
	{ 
		if(((*x)->key > data) && ((*x)->left!=NULL) && ((*x)->left->key != data))
			delete(&(*x)->left, data);
		else if(((*x)->key > data) && ((*x)->left!=NULL) && ((*x)->left->key == data))//Θελω να διαγραψω το αριστερό παιδι της ρίζας
		{
			tp temp = (*x)->left;
			if((temp->left == NULL) && (temp->right == NULL))//Χωρις παιδια
			{
				printf("\n5D");
				(*x)->left = NULL;
				free(temp);
			...
			if((temp->left != NULL) && (temp->right == NULL))//Μονο αριστερό παιδι
			{
				printf("\n6D");
				(*x)->left = temp->left;
				free(temp);
			...
			if((temp->left == NULL) && (temp->right != NULL))//Μονο δεξι παιδι
			{
				printf("\n7D");
				(*x)->left = temp->right;
				free(temp);
			...
			if((temp->left != NULL) && (temp->right != NULL))//εχει 2 παιδια
			{
				printf("\n8D");
				tp right = temp->right;
				tp left = temp->left;
			...
			delete(&(*x)->right, data);
		else if(((*x)->key < data) && ((*x)->right!=NULL) && ((*x)->right->key == data))//Θελω να διαγραψω το δεξι παιδι της ρίζας
		{
			tp temp = (*x)->right;
			if((temp->left == NULL) && (temp->right == NULL))//Χωρις παιδια
			{
	...
	else if((*x != root) && ((*x)->key != data))
	{
		if(((*x)->key > data) && ((*x)->left!=NULL) && ((*x)->left->key != data))
			delete(&(*x)->left, data);
		else if(((*x)->key > data) && ((*x)->left!=NULL) && ((*x)->left->key == data))//Θελω να διαγραψω το αριστερό παιδι.
		{
			tp temp = (*x)->left;
			if((temp->left == NULL) && (temp->right == NULL))//Χωρις παιδια
			{
			...
			delete(&(*x)->right, data);
		else if(((*x)->key < data) && ((*x)->right!=NULL) && ((*x)->right->key == data))//Θελω να διαγραψω το δεξί παιδι.
		{
			tp temp = (*x)->right;
			if((temp->left == NULL) && (temp->right == NULL))//Χωρις παιδια
			{
